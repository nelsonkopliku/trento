...
func NewClustersTable(s services.ChecksService, t services.TagsService, client consul.Client, clusters map[string]*cluster.Cluster) (ClustersTable, error) {
...
func NewClusterListHandler(client consul.Client, s services.ChecksService, t services.TagsService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		clustersTable, err := NewClustersTable(s, t, client, clusters)
		if err != nil {
			_ = c.Error(err)
			return
		}
